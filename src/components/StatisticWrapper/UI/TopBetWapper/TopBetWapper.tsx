        ...
        <ul className="module-header cr-position-radius p-top s-big headerBorder">
          <li className="left-content">
            <div className="left-inner">
              <div className="ellipsis-text module-title" title="Top bets">
                Top bets
              </div>
            </div>
          </li>
              ...
              <div className="ta-n-body ta-header pointer-events-none">
                <div className="ta-row border-bottom">
                  <div
                    ...
                    data-id="3a814b99-4015-8c94-ea36-4e384b4762f1-userName"
                    title="Username"
                    style={{
                      left: "0px",
                      right: "0px",
                  ...
                  <div
                    className="ta-cell ta-header-cell"
                    data-id="3a814b99-4015-8c94-ea36-4e384b4762f1-type"
                    title="Type"
                    style={{
                      left: "0px",
                      right: "0px",
                  ...
                  <div
                    className="ta-cell ta-header-cell"
                    data-id="3a814b99-4015-8c94-ea36-4e384b4762f1-amount"
                    title="Amount"
                    style={{
                      left: "0px",
                      right: "0px",
